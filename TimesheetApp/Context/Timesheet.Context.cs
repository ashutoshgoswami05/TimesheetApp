...
namespace TimesheetApp.Context
{
    ...
    public partial class Timesheet_projectEntities : DbContext
    {
        public Timesheet_projectEntities()
            : base("name=Timesheet_projectEntities")
        {
        }
        ...
        public virtual ObjectResult<Nullable<int>> sp_ValidateUser(string employeeId, string password)
        {
            var employeeIdParameter = employeeId != null ?
                new ObjectParameter("EmployeeId", employeeId) :
                new ObjectParameter("EmployeeId", typeof(string));
